...
require 'spec_helper'
require 'whois/parsers/whois.nic.space.rb'

describe Whois::Parsers::WhoisNicSpace, "status_registered.expected" do
  ...
  describe "#updated_on" do
    it do
      ...
      expect(subject.updated_on).to eq(Time.parse("2017-04-04T00:15:53.0Z"))
    end
  end
  describe "#expires_on" do
    it do
      expect(subject.expires_on).to be_a(Time)
      expect(subject.expires_on).to eq(Time.parse("2018-04-10T23:59:59.0Z"))
    end
  end
  ...
  describe "#registrant_contacts" do
    it do
      ...
      expect(subject.registrant_contacts[0].id).to eq("C39963-CNIC")
  ...
  describe "#admin_contacts" do
    it do
      ...
      expect(subject.admin_contacts[0].id).to eq("C39963-CNIC")
  ...
  describe "#technical_contacts" do
    it do
      ...
      expect(subject.technical_contacts[0].id).to eq("C39963-CNIC")
