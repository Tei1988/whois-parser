...
describe Whois::Parsers::WhoisNicPw, "status_registered.expected" do
  ...
  describe "#status" do
    it do
      expect(subject.status).to eq(["clientTransferProhibited https://icann.org/epp#clientTransferProhibited", "clientUpdateProhibited https://icann.org/epp#clientUpdateProhibited", "clientDeleteProhibited https://icann.org/epp#clientDeleteProhibited", "inactive https://icann.org/epp#inactive"])
    end
  end
  ...
  describe "#updated_on" do
    it do
      ...
      expect(subject.updated_on).to eq(Time.parse("2017-02-02 18:17:18 UTC"))
    end
  end
  describe "#expires_on" do
    it do
      expect(subject.expires_on).to be_a(Time)
      expect(subject.expires_on).to eq(Time.parse("2019-02-10 23:59:59 UTC"))
    end
  end
  ...
  describe "#nameservers" do
    it do
      ...
      expect(subject.nameservers[0].name).to eq("")
